        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataPrevisao = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ordens_servico_funcionarios_FuncionarioId",
                        column: x => x.FuncionarioId,
                        principalTable: "funcionarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ordens_servico_veiculos_VeiculoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ordens_servico_FuncionarioId",
                table: "ordens_servico",
                column: "FuncionarioId");

            migrationBuilder.CreateIndex(
                name: "IX_ordens_servico_VeiculoId",
                table: "ordens_servico",
                column: "VeiculoId");
